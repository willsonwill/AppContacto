...
//vendedor
Route::get('/registro-vendedor', 'VendedorController@index');
Route::get('/registro-vendedor-create', 'VendedorController@create');
//contacto
Route::get('/registro-contacto', 'ContactoController@index');
Route::get('/registro-contacto-create', 'ContactoController@create');
